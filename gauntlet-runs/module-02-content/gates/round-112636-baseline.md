# Content Library baseline — 2026-08-16T14:26:36Z

Mode: prod | Commit: c959730
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//content-gauntlet.mB12ZT
...
SCENARIO L5b: FAIL — upload-finalize rename-on-conflict: c1=200 c2=200 distinctIds=false rows=1 names=l5-dup.mp4 bothFilesOk=true (declaredSize=600)
...
L5b: FAIL — upload-finalize rename-on-conflict: c1=200 c2=200 distinctIds=false rows=1 names=l5-dup.mp4 bothFilesOk=true (declaredSize=600)
...
```
seeded 1200 items
SCENARIO L8: renderMs=148 fcpMs=108 maxFrameGapMs=62 framesOver200=0/26 consoleErrors=0
{"seeded":1200,"renderMs":148,"fcpMs":108,"maxFrameGapMs":62,"framesOver200ms":0,"totalFrames":26,"consoleErrors":[],"measuredAt":"2026-08-16T14:26:36.089Z"}
```
