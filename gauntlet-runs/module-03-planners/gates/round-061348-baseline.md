# Planners baseline — 2026-08-16T09:13:48Z

Mode: dev | Commit: 856d33e
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//planner-gauntlet.pa0Sjn

## PL8 (visual — wizard)

```
  (c) after Finish: modalOpen=false saveError=0 consoleErrors=3
FATAL: locator.click: Timeout 30000ms exceeded.
Call log:
[2m  - waiting for getByRole('button', { name: 'New Planner', exact: true })[22m
[2m    - locator resolved to <button type="button" class="ios-btn px-4 py-3 rounded-xl font-semibold text-[17px] w-full flex items-center justify-center transition-all disabled:opacity-50 disabled:cursor-not-allowed bg-ios-blue text-white shadow-sm hover:bg-blue-600 !py-2 !px-4 flex items-center gap-1">…</button>[22m
[2m  - attempting click action[22m
[2m    2 × waiting for element to be visible, enabled and stable[22m
[2m      - element is visible, enabled and stable[22m
[2m      - scrolling into view if needed[22m
[2m      - done scrolling[22m
[2m      - <div class="px-6 py-4 border-b border-ios-separator flex items-center justify-between bg-ios-background">…</div> from <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">…</div> subtree intercepts pointer events[22m
...
[2m       - waiting 500ms[22m
    ...
    at main (/Users/bestoptionnotebook/Documents/autoreels-web/scripts/gauntlet/planner-visual.mjs:222:71)
```
