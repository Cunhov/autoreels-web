# Planners baseline — 2026-08-16T19:05:57Z

Mode: prod | Commit: b62245e
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//planner-gauntlet.wBhEE4

## PL8 (visual — wizard)

```
  (c) EDIT step2 probe: ["Upload New","From Library","0 new files, 0 library items selected."]
  (c) GET /api/planners config.content: [{"type":"library_item","id":"9cfef771-7c23-407e-a210-102d42e0446b"}]
  (c) after Finish: modalOpen=false saveError=0 consoleErrors=1
  (c) GET /api/planners config.content: [{"type":"library_item","id":"9cfef771-7c23-407e-a210-102d42e0446b"}]
  (c) GET /api/planners config.content: [{"type":"library_item","id":"9cfef771-7c23-407e-a210-102d42e0446b"}]
SCENARIO PL8: FAIL — consoleErrors=1 pageErrors=0 created=true autoRotation=true/true edited=7h validation=true/true badAbsent=true mobileHScroll=0px
  console errors:
    - [gaunt-debug] edit config keys: [frequency, timezone, start_time, sleep_schedule, sort_order, caption_templates, caption_rotation, content] content: [{"type":"library_item","id":"9cfef771-7c23-407e-a2
```
