# Planners baseline — 2026-08-16T19:07:16Z

Mode: prod | Commit: b62245e
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//planner-gauntlet.fzjzHP

## PL8 (visual — wizard)

```
  (c) EDIT step2 probe: ["Upload New","From Library","0 new files, 0 library items selected."]
  (c) GET /api/planners config.content: [{"type":"library_item","id":"43a33668-db0e-4246-a11b-392dc2b6e9c5"}]
  (c) after Finish: modalOpen=false saveError=0 consoleErrors=3
  (c) GET /api/planners config.content: [{"type":"library_item","id":"43a33668-db0e-4246-a11b-392dc2b6e9c5"}]
  (c) GET /api/planners config.content: [{"type":"library_item","id":"43a33668-db0e-4246-a11b-392dc2b6e9c5"}]
SCENARIO PL8: FAIL — consoleErrors=4 pageErrors=0 created=true autoRotation=true/true edited=7h validation=true/true badAbsent=true mobileHScroll=0px
  console errors:
    - [gaunt-debug] NEW-PLANNER reset branch
    - [gaunt-debug] edit config keys: [frequency, timezone, start_time, sleep_schedule, sort_order, caption_templates, caption_rotation, content] content: [{"type":"library_item","id":"43a33668-db0e-4246-a1
    - [gaunt-debug] AFTER setSelectedContentIds: ["43a33668-db0e-4246-a11b-392dc2b6e9c5"]
    - [gaunt-debug] NEW-PLANNER reset branch
```
