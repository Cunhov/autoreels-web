# Analytics/Settings/Channels-UI baseline — 2026-08-16T15:49:26Z

Mode: prod | Commit: 951d20c
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//analytics-gauntlet.Q01D2K

## scenarios

```
SCENARIO S1: FAIL — dashboard window: in=s1-in-1,s1-in-2,s1-in-3,s1-pending ok=true limit2=true badDate400=true statusFilter=true | insights db: source=db posts=8 likes=210/210 cacheStable=true | zero: posts=0 zeros=false | noToken=200
...
SCENARIO S4: PASS — list=4 | ok: 200/gauntlet_ok calls=1 | bad: 400 | noToken: 400 | inactive: 200/gauntlet_inactive

=== SUMMARY ===
S1: FAIL — dashboard window: in=s1-in-1,s1-in-2,s1-in-3,s1-pending ok=true limit2=true badDate400=true statusFilter=true | insights db: source=db posts=8 likes=210/210 cacheStable=true | zero: posts=0 zeros=false | noToken=200
...
S4: PASS — list=4 | ok: 200/gauntlet_ok calls=1 | bad: 400 | noToken: 400 | inactive: 200/gauntlet_inactive
...
SCENARIO S8: {"seeded":144,"renderMs":187,"fcpMs":null,"maxFrameGapMs":36.10000002384186,"framesOver200":0,"totalFrames":6,"consoleErrors":[],"bodyNoNaN":true,"measuredAt":"2026-08-16T15:49:26.932Z"}
SCENARIO S8: PASS — renderMs=187 fcpMs=null maxFrameGapMs=36.10000002384186 framesOver200=0 consoleErrors=0 bodyNoNaN=true [first run — baseline recorded]
```
