# Analytics/Settings/Channels-UI baseline — 2026-08-16T16:03:47Z

Mode: prod | Commit: 951d20c
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//analytics-gauntlet.8vlM1h
...
SCENARIO S6: PASS — settings: rendered=true savedToast=true persisted=true errToast=true unchangedAfterInvalid=true masked=true mobileHScroll=0px consoleErrors=2(unexpected=0) pageErrors=0
  S7 console errors: ["Failed to load resource: the server responded with a status of 400 (Bad Request)","Error saving settings: Error: PUBLISH_MIN_INTERVAL_SECONDS must be a non-negative number\n    at J (http://127.0.0.1:65462/_next/static/chunks/bc3e24c147b77d61.js:1:6818)","Failed to load resource: the server responded with a status of 400 (Bad Request)","Failed to load resource: net::ERR_NAME_NOT_RESOLVED","Failed to load resource: net::ERR_NAME_NOT_RESOLVED"]
  S7 4xx/5xx responses: ["400 http://127.0.0.1:65462/api/channels/s7-bad/test"]
...
SCENARIO S8: {"seeded":144,"renderMs":177,"fcpMs":null,"maxFrameGapMs":49.30000001192093,"framesOver200":0,"totalFrames":6,"consoleErrors":[],"bodyNoNaN":true,"measuredAt":"2026-08-16T16:03:47.433Z"}
SCENARIO S8: PASS — renderMs=177 fcpMs=null maxFrameGapMs=49.30000001192093 framesOver200=0 consoleErrors=0 bodyNoNaN=true [first run — baseline recorded]
```
