# Publisher baseline — 2026-08-16T07:13:21Z

Mode: prod | Commit: 1eddd7d
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//publisher-gauntlet.AgvD5y
...
SCENARIO P3: FAIL — child_create_calls_total=6 (t1=3+t2=3; bar: 3) after1=pending/attempts=1 final=published
...
SCENARIO P8: PASS — post=failed channel=inactive/expires=true refresh_calls=1 ChannelRefresh_lines=1
  P9a: t1_elapsed=10022ms published_t1=5 oldest5=true → ok
  P9a(2): published_all=10 ok_publish_calls(all)=10 → ok
  P9b: elapsed=46015ms timeout=true slow=processing_upload queued=processing → ok
...
P3: FAIL — child_create_calls_total=6 (t1=3+t2=3; bar: 3) after1=pending/attempts=1 final=published
