# Publisher baseline — 2026-08-16T14:31:17Z

Mode: prod | Commit: c959730
Evidence dir: /var/folders/28/xppyht0s0w9cmfv134s0zxcm0000gn/T//publisher-gauntlet.6BUeyg
...
SCENARIO P8: PASS — post=failed channel=inactive/expires=true refresh_calls=1 ChannelRefresh_lines=1
  P9a: t1_elapsed=10021ms published_t1=5 oldest5=true → ok
  P9a(2): published_all=10 ok_publish_calls(all)=10 → ok
  P9b: elapsed=46010ms timeout=true slow=processing_upload queued=processing → ok
