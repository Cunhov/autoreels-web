        ...
        >
            ...
            >
                    ...
                    {activeTool === "crop" ? (
                        <div className="relative w-full h-full max-w-4xl max-h-[85dvh]">
                            ...
                            <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex gap-4 bg-black/70 backdrop-blur px-4 py-2 rounded-full">
                                <button
                                    className="text-xs text-white p-2 hover:text-ios-blue"
                                    onClick={() => setAspect(1)}
                                >
                                    1:1
                                </button>
                ...
                <div className="h-20 bg-black/50 backdrop-blur-md border-t border-white/10 flex items-center justify-center gap-8 pb-4">
                    ...
                    >
                        <div
                            className={`p-2 rounded-xl ${activeTool === "crop" ? "bg-white/10" : ""}`}
                        >
                            <Crop size={24} />
                        </div>
                    ...
                    >
                        <div
                            className={`p-2 rounded-xl ${activeTool === "draw" ? "bg-white/10" : ""}`}
                        >
                            <Pen size={24} />
                        </div>
                    ...
                    >
                        <div
                            className={`p-2 rounded-xl ${activeTool === "text" ? "bg-white/10" : ""}`}
                        >
                            <Type size={24} />
                        </div>
