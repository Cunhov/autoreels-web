...
export type IgResult =
    | { kind: "ok"; meta: { permalink?: string | null; media_type?: string | null; caption?: string | null } | null; metrics: IgMetrics; igCalls: number }
...
export async function fetchMediaInsights(
    ...
    return { kind: "ok", meta, metrics, igCalls };
}
